...
**Steam価格監視システム** - セール時の過去最安値更新を検知し、WebサイトとDiscord通知で情報提供するシステム
...
- **SQLite3**: ファイルベースDB（移植性重視）
- **価格履歴**: 最大1年間保持
- **自動クリーンアップ**: 古いデータの定期削除
- **バックアップ**: データベースファイルの手動バックアップ推奨
