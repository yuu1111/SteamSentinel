...
class NavigationBar {
    ...
    private getNavigationConfig(): NavigationConfig {
        return {
            brand: {
                name: 'SteamSentinel',
                icon: 'bi-controller'
    ...
    private createNavItem(item: NavigationItem, isLeftNav: boolean = true): string {
    ...
    public mount(elementId: string = 'navigation-container'): void {
    ...
    public updateActiveState(activeId: string): void {
...
// グローバルに公開
(window as any).NavigationBar = NavigationBar;
